...
ویژگی‌های کلیدی:
- ۲۴ قانون سفارشی با سطح‌بندی دقیق (level 10–15)
...
| Brute-Force روی کاربر مدیریتی، DoS شدید، Honeypot | 100003,100006,100007,100101,100103,100014,100017,100019 | بلاک کامل IP با iptables | ۲۴ ساعت |
